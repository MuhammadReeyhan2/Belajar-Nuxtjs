...
<template>
  <div class="w-full max-w-sm p-4 bg-white rounded-lg shadow-[0_30px_60px_rgba(0,0,0,0.15)] sm:p-6 md:p-8">
    <form class="" @submit.prevent="submitLogin">
      ...
      <button type="submit" class="w-full flex justify-center items-center text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">
      ...
      <div class="text-sm font-medium text-gray-500">
          Don't have an Account ? <NuxtLink to="/register" class="text-orange-700 hover:underline">Sign up</NuxtLink>
      </div>
    </form>
  </div>
</template>