...
<template>
  <section class="py-10">
    <div class="container">
      <NuxtLink to="/product" class="bg-gray border border-slate-300 w-max flex
...
center p-5 h-[500px]">
        ...
        <div class="w-1/2 pl-5">
          ...
          <div class="flex flex-col gap-4">
            <div class="w-full flex items-center gap-2 bg-orange-600 text-white py-
3 justify-center rounded-lg cursor-pointer hover:bg-orange-600/80 transition
